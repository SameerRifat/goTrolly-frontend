          ...
          {({
            ...
            <Form onSubmit={handleSubmit}>
              <div className='text-center mb-5'>
                <h2 className='p-1.5 border-b-2 border-gray-300 inline-block font-medium text-lg sm:text-xl md:text-2xl'>Shipping Details</h2>
              </div>
              <div className='grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6'>
                ...
                <div className="col-span-full flex items-center justify-end mb-8">
                  <input type="submit" value="Continue"
                    className='font-medium bg-broom py-3 px-7 text-black hover:scale-105 hover:shadow-md shadow-sm cursor-pointer'
                  />
                </div>
              </div>
            </Form>
